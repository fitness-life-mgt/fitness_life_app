        ...
        />*/}
          ...
          <Animatable.View style={styles.footer} animation="fadeInUpBig">
            ...
            <Text style={styles.textDetailsMedium}>
              Fitness life Gym, Kirinda road, Kamburupitiya, Matara
            </Text>
            <Text style={styles.textDetailsMedium}> </Text>
            <Text style={styles.textSubtitle}>Contact Us : </Text>
            <Text style={styles.textDetailsMedium}>0774525774</Text>
            <Text style={styles.textDetailsMedium}>
              wannifitnesslife@gmail.com
            </Text>
            <Text style={styles.textDetailsMedium}> </Text>
            <Text style={styles.textSubtitle}>Website : </Text>
            <Text style={styles.textDetailsMedium}>fitness-life.lk</Text>
          </Animatable.View>
        </View>
      </ScrollView>
    </View>
